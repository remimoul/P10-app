...
const Header = () => (
  ...
  >
    <h1 className="text-5xl font-bold bg-gradient-to-r from-red-900 to-red-400 bg-clip-text text-transparent mb-4">
      F1 LEAGUES
    </h1>
    <div className="flex items-center justify-center gap-4">
      <div className="h-px flex-1 bg-gradient-to-r from-transparent via-red-600 to-transparent" />
      <p className="text-gray-600 uppercase tracking-widest text-2xl">
